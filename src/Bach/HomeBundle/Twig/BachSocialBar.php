...
class BachSocialBar extends \Twig_Extension{
    ...
    public function getSocialButtons($parameters = array())
    {
      ...
      return $this->container->get('bach.socialBarHelper')->socialButtons($render_parameters);
    }
    ...
    public function getFacebookLikeButton($parameters = array())
    {
       ...
       return $this->container->get('bach.socialBarHelper')->facebookButton($parameters);
    }
    ...
    public function getTwitterButton($parameters = array())
    {
       ...
       return $this->container->get('bach.socialBarHelper')->twitterButton($parameters);
    }
    ...
    public function getGooglePlusButton($parameters = array())
    {
       ...
       return $this->container->get('bach.socialBarHelper')->googlePlusButton($parameters);
    }
}
