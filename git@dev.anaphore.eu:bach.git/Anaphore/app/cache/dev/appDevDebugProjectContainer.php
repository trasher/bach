...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'anph_indexation.file_driver_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Anph\IndexationBundle\Service\FileDriverManager A Anph\IndexationBundle\Service\FileDriverManager instance.
     */
    protected function getAnphIndexation_FileDriverManagerService()
    {
        return $this->services['anph_indexation.file_driver_manager'] = new \Anph\IndexationBundle\Service\FileDriverManager();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'azerty', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager50a0a494f38f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager50a0a494f38f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_50a0a494f38f2.php';
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/symfony/src/Anph/IndexationBundle/Entity')), 'Anph\\IndexationBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AnphIndexationBundle' => 'Anph\\IndexationBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50a0a494f38f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'fcfe28f4f96b6167f7e541210b30616ac');
    }
    ...
    /**
     * Gets the 'solarium.client.adapter.default' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Solarium_Client_Adapter_Http A Solarium_Client_Adapter_Http instance.
     */
    protected function getSolarium_Client_Adapter_DefaultService()
    {
        return $this->services['solarium.client.adapter.default'] = new \Solarium_Client_Adapter_Http(array('host' => 'localhost', 'port' => 8080, 'path' => '/solr', 'timeout' => 5, 'core' => 'core0'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Solarium_Client A Solarium_Client instance.
     */
    protected function getSolarium_Client_DefaultService()
    {
        $this->services['solarium.client.default'] = $instance = new \Solarium_Client();

        $instance->setAdapter($this->get('solarium.client.adapter.default'));
    ...
    {
        return $this->services['solarium.data_collector'] = new \Nelmio\SolariumBundle\Logger();
    }
     ...
     *
     * @return EntityManager50a0a494f38f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    /**
     * Gets the solarium.client service alias.
     *
     * @return Solarium_Client An instance of the solarium.client.default service
     */
    protected function getSolarium_ClientService()
    {
        return $this->get('solarium.client.default');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AnphIndexationBundle' => 'Anph\\IndexationBundle\\AnphIndexationBundle',
            ...
            'locale' => 'en',
            'secret' => 'fcfe28f4f96b6167f7e541210b30616ac',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'fcfe28f4f96b6167f7e541210b30616ac',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_50a0a494f38f2.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50a0a494f38f2_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'anph_indexation_file_driver_manager.class' => 'Anph\\IndexationBundle\\Service\\FileDriverManager',
